  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        key: "video_review",
        title: "视频数据复盘",
        subtitle: "深度复盘，沉淀规律与下轮选题",
        skillId: "baolu_review_engine",
        promptTemplate: "这是复盘系统的固定单技能任务，只做深度复盘（唯一模式，不提供精简版）。必须完整读取用户上传的 CSV / Excel / 表格数据，输出数据质量审计、总览、作品分层、内容结构健康度、单条深拆、完播、互动、趋势预警、规律、方法论和下周期选题；核心字段缺失时进入受限维度清单，禁止因为缺字段而失败或无输出。只依据本轮证据，不假装读取链接、视频画面或后台，不编造平台原因和业务转化。"
      },
      {
        key: "live_script",
        title: "招商直播话术",
