...
type BeautyMediaQuote = { runId: string; imageCount: 1 | 3; creditCost: number; canConfirm: boolean; existing: boolean; stateCode: string; retryEligible: boolean; retryOfJobId?: string; regenerationEligible?: boolean; regenerationOfJobId?: string; deliveryMode?: "real_provider_composed"; estimatedProviderCostYuan?: number; message: string; imagePlan: BeautyXhsImagePlan };
