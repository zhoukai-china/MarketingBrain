...
const termsSections = [
  ["1. 服务范围", "思潼 AI 增长飞轮为内测中的企业经营辅助工具，提供诊断、内容生成、智能体协作、资料管理等功能。具体开放能力以页面和双方约定为准。"],
  ...
  ["8. 条款更新与联系", "服务升级或规则变化时，条款可能更新并在本页面标注日期。对条款有疑问，可联系向你发放邀请码的思潼 AI 增长飞轮服务人员。"]
] as const;
...
const privacySections = [
  ...
  ["8. 政策更新与联系", "产品能力或处理方式变化时，本政策可能更新并在本页面标注日期。如有隐私问题或权利请求，可联系向你发放邀请码的思潼 AI 增长飞轮服务人员。"]
] as const;
...
export default function LegalPage({ kind }: LegalPageProps) {
  ...
  useEffect(() => {
    document.title = `${title} - 思潼 AI 增长飞轮`;
  }, [title]);
    ...
    <main className="legalPage">
      <article className="legalCard">
        ...
        <div className="legalIntro">
          欢迎使用思潼 AI 增长飞轮。请在使用服务前阅读本{isTerms ? "条款" : "政策"}；继续使用即表示你理解并接受其中与当前服务有关的内容。
        </div>
