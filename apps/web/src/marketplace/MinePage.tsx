  ...
  return (
    <main className="app-wrap">
      ...
      <section className="view view-mine">
        ...
        <ReferralLinkCard />
        {/*
         * 2026-09-18（老板）：市场合伙人的「专属链接 + 分销数据」**不再挂在用户端这个页面**。
         * 原话：「不应该给所有用户展示啊，就是个单独的后台，由我单独找市场合伙人发放，不应该在用户端。」
         * 现在独立成 `/partner`（`marketplace/PartnerConsolePage.tsx`），不进用户端导航，
         * 地址由平台方单独发给已授予资格的合伙人；未授予者打开只看到「无资格」提示，接口仍 403。
         */}
        {/*
         * 2026-09-16（用户）：
